package com.example.soundmatch.viewmodels.artistviewmodel
...
class ArtistDetailViewModel @Inject constructor(
    ...
    private val artistId =
        savedStateHandle.get<String>(SoundMatchNavigationDestinations.ArtistDetailScreen.NAV_ARG_ARTIST_ID)!!
