 ...
 * track. This is a wrapper over [com.example.soundmatch.ui.components.SoundMatchCompactListItemCard].
...
@Composable
fun SoundMatchCompactTrackCard(
    ...
    contentPadding: PaddingValues = SoundMatchCompactTrackCardDefaults.defaultContentPadding
) {
    ...
    CompositionLocalProvider(
        LocalContentColor provides MaterialTheme.colorScheme.onSurface.copy(alpha = if (track.trackUrlString == null) 0.5f else 1f)
    ) {
...
/**
 * Contains default values used by [SoundMatchCompactTrackCard].
 */
object SoundMatchCompactTrackCardDefaults {
